  ...
  return (
    <footer ref={sectionRef} className="relative">
      ...
      >
        ...
        {/* Contact Us text overlay & WhatsApp action badge */}
        <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-10 lg:p-14 z-10">
          <div className="max-w-xl space-y-1.5 sm:space-y-2">
            <p className="font-mono text-[9px] sm:text-[11px] tracking-[0.25em] text-gold uppercase font-semibold">
              {translate('DIRECT CONCIERGE', currentLang)}
            </p>
            <h2 className="footer-heading font-display text-3xl sm:text-5xl lg:text-6xl text-white group-hover:text-gold transition-colors duration-300 uppercase font-light leading-tight">
