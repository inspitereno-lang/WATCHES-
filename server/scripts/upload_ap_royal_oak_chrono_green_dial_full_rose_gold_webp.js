...
const TEMP_DIR = path.join(__dirname, 'temp_webp_ro_chrono_green_gold');
...
async function main() {
  try {
    console.log('========================================================================');
    console.log('Processing Royal Oak Chronograph Green Dial Full Rose Gold');
    console.log('========================================================================');

    const file1 = 'Royal Oak Chronograph Green Dial Full Rose Gold_1.png'; // MAIN BANNER
    const file2 = 'Royal Oak Chronograph Green Dial Full Rose Gold_2.png';
    const file3 = 'Royal Oak Chronograph Green Dial Full Rose Gold_3.png';
    const file4 = 'Royal Oak Chronograph Green Dial Full Rose Gold_4.png';
    ...
    const mainBannerUrl = await convertToWebpAndUpload(path1, 'ro_chrono_green_dial_full_rose_gold_main_1');
    const img2Url = await convertToWebpAndUpload(path2, 'ro_chrono_green_dial_full_rose_gold_2');
    const img3Url = await convertToWebpAndUpload(path3, 'ro_chrono_green_dial_full_rose_gold_3');
    const img4Url = await convertToWebpAndUpload(path4, 'ro_chrono_green_dial_full_rose_gold_4');
    ...
    const productPayload = {
      ...
      description: 'The Audemars Piguet Royal Oak Chronograph in full 18-carat rose gold features a rich green "Grande Tapisserie" dial. Driven by the Calibre 4401 automatic chronograph movement with column wheel and flyback function.',
      features: [
      ...
      descriptionAr: 'ساعة أوديمار بيغيه رويال أوك كرونوغراف بالذهب الوردي الكامل عيار 18 قيراطاً مع ميناء أخضر جذاب بنمط "غراند تابسيري" وحركة كرونوغراف أوتوماتيكية متطورة عيار 4401.',
      featuresAr: [
