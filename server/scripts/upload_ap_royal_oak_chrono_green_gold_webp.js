...
const TEMP_DIR = path.join(__dirname, 'temp_webp_ap_chrono_green_gold');
...
async function main() {
  try {
    console.log('========================================================================');
    console.log('Processing Audemars Piguet Royal Oak Chronograph Green Dial Full Rose Gold');
    console.log('========================================================================');

    const file1 = 'Audemars Piguet Royal Oak Chronograph Green Dial 41 mm_1.png'; // MAIN ICON
    const file2 = 'Audemars Piguet Royal Oak Chronograph Green Dial 41 mm_2.png';
    const file3 = 'Audemars Piguet Royal Oak Chronograph Green Dial 41 mm_3.png';
    const file4 = 'Audemars Piguet Royal Oak Chronograph Green Dial 41 mm_4.png';
    ...
    const mainBannerUrl = await convertToWebpAndUpload(path1, 'ap_ro_chrono_green_gold_main_1');
    const img2Url = await convertToWebpAndUpload(path2, 'ap_ro_chrono_green_gold_2');
    const img3Url = await convertToWebpAndUpload(path3, 'ap_ro_chrono_green_gold_3');
    const img4Url = await convertToWebpAndUpload(path4, 'ap_ro_chrono_green_gold_4');
    ...
    const existingProduct = await Product.findOne({
      $or: [
        { name: { $regex: /Royal Oak Chronograph Green Dial.*Rose Gold/i } },
        { reference: '262400OR.OO.1320OR.08' }
      ]
    });
    ...
    if (!targetId) {
      ...
      targetId = maxProduct && typeof maxProduct.id === 'number' ? maxProduct.id + 1 : 109;
    }
    ...
    const productPayload = {
      id: targetId,
      name: 'Royal Oak Chronograph Green Dial Full Rose Gold',
      brand: 'Audemars Piguet',
      audience: 'Mens',
      factory: 'Royal Oak Chronograph – Green Dial, Full Rose Gold',
      model: 'Royal Oak',
      reference: '262400OR.OO.1320OR.08',
      material: 'Rose gold case and bracelet, green dial, sapphire crystal',
      size: '41 mm',
      caliber: 'Caliber 4401',
      warranty: 'Two Year Machine',
      priceUSD: '$1,690.00',
      ...
      casing: 'Rose gold',
      bezel: 'Rose gold octagonal bezel',
      glass: 'Sapphire crystal',
      waterResistance: '50m waterproof vacuum tested',
      description: 'The Audemars Piguet Royal Oak Chronograph in full 18-carat rose gold features a captivating "Grande Tapisserie" green dial. Powered by the integrated Calibre 4401 automatic chronograph movement with flyback function, column wheel, and date display.',
      features: [
        'Movement: Automatic chronograph movement (Caliber 4401)',
        'Casing Material: Rose gold',
        'Bezel: Rose gold octagonal bezel',
        'Glass / Crystal: Sapphire crystal',
        'Reference Number: 262400OR.OO.1320OR.08',
        'Material Composition: Rose gold case and bracelet, green dial, sapphire crystal',
        'Diameter Size: 41 mm',
      ...
      isVisible: true,
      // Arabic translations
      nameAr: 'رويال أوك كرونوغراف ميناء أخضر ذهب وردي كامل',
      brandAr: 'أوديمار بيغيه',
      modelAr: 'رويال أوك',
      materialAr: 'علبة وسوار من الذهب الوردي، ميناء أخضر، زجاج ياقوتي كريستال',
      movementAr: 'حركة كرونوغراف أوتوماتيكية (عيار 4401)',
      casingAr: 'ذهب وردي',
      bezelAr: 'إطار ثماني الأضلاع من الذهب الوردي',
      glassAr: 'زجاج ياقوتي كريستال',
      waterResistanceAr: 'مقاومة الماء حتى 50 متراً',
      warrantyAr: 'ضمان ماكينة لمدة عامين',
      descriptionAr: 'ساعة أوديمار بيغيه رويال أوك كرونوغراف بالذهب الوردي الكامل مع ميناء أخضر بنمط "غراند تابسيري" الفاخر وحركة كرونوغراف أوتوماتيكية عيار 4401.',
      featuresAr: [
        'الحركة: حركة كرونوغراف أوتوماتيكية (عيار 4401)',
        'مادة الهيكل: ذهب وردي',
        'الإطار: إطار ثماني الأضلاع من الذهب الوردي',
        'الزجاج: زجاج ياقوتي كريستال',
        'الرقم المرجعي: 262400OR.OO.1320OR.08',
        'تركيبة المواد: علبة وسوار من الذهب الوردي، ميناء أخضر، زجاج ياقوتي',
        'الأبعاد: 41 مم',
        'العيار / المحرك: Caliber 4401',
        'الشحن: شحن مجاني',
        'الضمان: ضمان ماكينة لمدة عامين'
      ]
    };
